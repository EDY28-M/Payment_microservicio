...
COPY ["PaymentMicroservicio.sln", "./"]
COPY ["PaymentMicroservicio/PaymentMicroservicio.csproj", "PaymentMicroservicio/"]
RUN dotnet restore "PaymentMicroservicio.sln"

# Copiar todo el código fuente
COPY . .

# Compilar en modo Release
WORKDIR /src/PaymentMicroservicio
