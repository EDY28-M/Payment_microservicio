...
public interface IPaymentService
{
    ...
    /// <summary>
    /// Confirma el pago de una sesión consultando Stripe directamente (fallback sin webhooks)
    /// </summary>
    Task<PaymentStatusResponse?> ConfirmSessionPaymentAsync(string sessionId);
